...
import { CheckCircle, Package, Calendar, ArrowRight, Home, CreditCard, Shield, Copy, Download, AlertCircle } from 'lucide-react';
...
const OrderSuccess = () => {
  ...
  // Fetch payment status if payment ID is available
  useEffect(() => {
    const fetchPaymentStatus = async () => {
      if (orderDetails?.paymentId && orderDetails?.orderId) {
        setIsLoadingPayment(true);
        try {
          const status = await PaymentService.getPaymentStatus(orderDetails.orderId);
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <p className="text-gray-600">Razorpay Secure Payment</p>
                    </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-blue-900 mb-1">Payment Confirmed</h3>
