...
import { X, Upload, Trash2, Plus, Save, AlertCircle, Cloud, Database } from 'lucide-react';
...
const EnhancedProductForm: React.FC<EnhancedProductFormProps> = ({ product, onSubmit, onClose }) => {
  ...
  const populateForm = (product: Product) => {
    ...
    if (product.images && Array.isArray(product.images)) {
      setExistingImages([product.image, ...product.images].filter(Boolean));
  ...
  const validateForm = () => {
    ...
    // Validate that we have at least one image (temporarily disabled for testing)
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-green-800">
                  Product saved successfully! Images uploaded to Cloudinary and data stored in Google Sheets.
                </p>
              </div>
            </div>
          </div>
        ...
        {loading && uploadProgress > 0 && (
          <div className="mx-6 mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-medium text-blue-800">Uploading images to Cloudinary...</span>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-8">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-green-50 p-6 rounded-lg border border-blue-200">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Product Images (Cloudinary)</h3>
              <span className="text-sm text-gray-600">- Images will be optimized and stored in the cloud</span>
            </div>
            ...
            {images && images.length > 0 && (
              <div className="mb-4">
                <h4 className="text-sm font-medium text-gray-700 mb-2">New Images (Ready for Upload)</h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="border-2 border-dashed border-blue-300 rounded-lg p-6 text-center bg-white">
              ...
              <p className="text-sm text-gray-600 mt-2">
                Upload multiple images (max 10MB each). First image will be the main product image.
              </p>
              <p className="text-xs text-blue-600 mt-1">
                Images will be automatically optimized and stored in Cloudinary CDN
              </p>
            </div>
